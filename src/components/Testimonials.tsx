          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="flex justify-center mb-6">
               ...
               <p className="text-xl md:text-2xl text-gray-700 dark:text-gray-300 text-center mb-8 leading-relaxed font-medium">
                 &ldquo;{translate(`testimonials.items.${currentIndex}.text`)}&rdquo;
               </p>


              <div className="text-center">
                <p className="text-lg font-semibold text-[#4B2142] dark:text-white font-heading">
                  {translate(`testimonials.items.${currentIndex}.name`)}
                </p>
              </div>
            </motion.div>
          </AnimatePresence>
          ...
          <div className="flex justify-center gap-2 mt-6">
            {testimonials.map((_, index) => (
              ...
              className={`w-3 h-3 rounded-full transition-all ${
                index === currentIndex ? 'bg-[#C8A04D] w-8' : 'bg-gray-300 dark:bg-gray-600'
              }`}
              />
            ))}
          </div>
